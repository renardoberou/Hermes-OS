...
5. **`action`** — Native Decision Bridge v0.4.2: `action <id> --verb approve|reject|queue|dry-run|execute|done` plus `action system --verb refresh`, used by Android buttons and recorded in `action-receipts.jsonl`.
